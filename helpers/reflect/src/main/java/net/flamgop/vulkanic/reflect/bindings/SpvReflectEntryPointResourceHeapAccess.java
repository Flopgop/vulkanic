...
public final class SpvReflectEntryPointResourceHeapAccess {
    ...
    public SpvReflectEntryPointResourceHeapAccess(Arena arena) {
        this.segment = arena.allocate(LAYOUT);
    }

    
    public SpvReflectEntryPointResourceHeapAccess(MemorySegment segment) {
